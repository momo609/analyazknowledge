...
//	        sbChoices.append(choices.split(cIndex[i])[1]);
	        ...
	        mcq.setLevel(Integer.parseInt(s.split("能力水平:")[1]));
	    ...
	    private static void addFBQ(String s,Map<Integer,Object> list,int order) {
	        ...
	        fbq.setLevel(Integer.parseInt(s.split("能力水平:")[1]));
	    ...
	    private static void addJQ(String s,Map<Integer,Object> list,int order) {
	        ...
	        jq.setLevel(Integer.parseInt(s.split("能力水平:")[1]));
	        jq.setQ_order(order);
	        jq.setType(2);
	        list.put(order,jq);
	    ...
	    private  void addSCQ(String s,Map<Integer,Object> list,int order) {
	        ...
	        sc.setLevel(Integer.parseInt(s.split("能力水平:")[1]));
	        sc.setQ_order(order);
	        sc.setType(1);
	        list.put(order, sc);
